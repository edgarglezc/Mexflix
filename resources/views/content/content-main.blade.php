        ...
        <p class="text-white mt-4">Todo el contenido</p>
          <div class="glide__track" data-glide-el="track">
              ...
              <li class="glide__slide text-gray-700 dark:text-gray-400 max-h-1">
                  <a class="text-white mt-4" href="{{route('content.show', $content->id)}}">{{ $content->name }} <img style="height: 15rem;width:max-content;object-fit: cover;" src="{{ asset($content->image_path) }}" alt=""></a>
              </li>
              @endforeach
              </ul>
          </div>
